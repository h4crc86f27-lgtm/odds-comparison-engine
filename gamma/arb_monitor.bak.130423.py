...
def get_comp_list():
    ...
    cur  = conn.cursor()
    cur.execute("select * from comps where ignore_comp=0")# and id=80")#and id=80")# and id=40")# and id=56")#and (id=144 or id=78 or id=56 or id=14 or id=40)") # 144 eerste and (id=14 or id=40)")#40")#UEFA 207")# where id=6") #40 is EPL#56 engcha
    rows = cur.fetchall()
    conn.close()
    for row in rows:
            ...
            if row[8] is None:
                if row[10] is not None:
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(""),"contra":"","qrbet":{"name":row[9],"id":row[10]},"league":row[1]}) # << here just need to splice in something benign for ub if null
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(""),"contra":"","qrbet":{"name":row[9],"id":row[10]},"league":row[1]}) # << here just need to splice in something benign for ub if null
                else:
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(""),"contra":"","qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(""),"contra":"","qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
                ...
                if row[10] is not None:
                    ...
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(""),"contra":row[8],"qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(""),"contra":row[8],"qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
        else:
            if row[8] is None:
                if row[10] is not None:
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":"","qrbet":{"name":row[9],"id":row[10]},"league":row[1]}) 
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":"","qrbet":{"name":row[9],"id":row[10]},"league":row[1]}) 
                else:
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":"","qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":"","qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
 
            else:
                if row[10] is not None:
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":row[8],"qrbet":{"name":row[9],"id":row[10]},"league":row[1]})
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":row[8],"qrbet":{"name":row[9],"id":row[10]},"league":row[1]})
                else:
                    if row[14] is not None:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":row[14],"winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":row[8],"qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
                    else:
                        comps.append({"m8bets":m8bets,"bet3000":bet3000,"betalpha":betalpha,"yess365":yess365,"bingoal":"","winkel_toto":winkel_id,"toto":str(row[4]),"betfair":str(row[2]),"unibet":str(row[6]),"contra":row[8],"qrbet":{"name":"","id":""},"league":row[1]}) # << here just need to splice in something benign for ub if null
