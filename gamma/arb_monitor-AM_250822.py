...
def process_comp(comp_meta):#toto_id,bf_id,league):
    ...
    try:
        ...
        """with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
            ...
            future_to_url = {executor.submit(pull_betfair_data,  comp_meta['betfair'], comp_meta['league'],betfair_markets): "betfair" }
            for future in concurrent.futures.as_completed(future_to_url,timeout=30):
                ...
                try:
                    ...
                    if len(betfair_data)==0:
                        ...
                        print("bf>0:",time.time() - comp_start_time)

                except Exception as msg:
                    print("bf err:",str(msg))
            if betfair_data=={}:
        ...
        try:
            ...
            if comp_meta['winkel_toto']=="":
                ...
                pass#do_insert_winkel_toto(winkel_toto_data,betfair_data,comp_meta['league'],winkel_toto_teams,"")
...
def go(comps):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=threads) as executor:
        executor.map(process_comp_seq,comps)#executor.map(process_comp, comps )
