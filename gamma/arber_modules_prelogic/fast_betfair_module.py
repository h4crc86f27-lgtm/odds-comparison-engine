...
def betfair_data_thread(event_id,event,market_dict):
        ...
        #print(event_id,market_dict)
        #here, setup the marketids from the dict..
        book_list=[]
        id_list=[]

        if 'Match Odds' in market_dict:
            h2h_id = market_dict['Match Odds']
            book_list.append("h2h")
            id_list.append(h2h_id)
        else:
            h2h_id=0
        if 'Over/Under 2.5 Goals' in market_dict:
            ou25_id = market_dict['Over/Under 2.5 Goals']
            book_list.append("ou25")
            id_list.append(ou25_id)
        else:
            ou25_id=0
        if 'Over/Under 3.5 Goals' in market_dict:
            ou35_id = market_dict['Over/Under 2.5 Goals']
        else:
            ou35_id=0
        if 'Double Chance' in market_dict:
            dc_id = market_dict['Double Chance']
        else:
            dc_id=0
        if 'Draw no Bet' in market_dict:
            dnb_id = market_dict['Draw no Bet']
            book_list.append("dnb")
            id_list.append(dnb_id)
        else:
            dnb_id=0
        if 'Half Time' in market_dict:
            ht_1x2_id = market_dict['Half Time']
        else:
            ht_1x2_id=0
            

        #here, get teh consolidated markets in one hit,, then mod the lower section to get these
        books = get_market_books(id_list)
        for d in range(0,len(book_list)):
            if book_list[d]=="h2h":
                book_h2h = books[d]
        ...
        try:
            ...
            #print("found h2h_id initial:",h2h_id)
        except:
...
####### here do the other markets,, will clean this up later.
	#uo 2.5
        ...
        """try:
            ...
            #print("found uo25_id initial:",h2h_id)
        except:
            #print("notfound uo25_id initial:",h2h_id)
            comp_market = pull_markets([event_id])
            ou25_id=get_event_ou25(comp_market,event_id)
        """
        try:
	...
	#uo 3.5
        ...
        """try:
            ...
            #print("found uo35_id initial:",h2h_id)
        except:
            #print("notfound uo35 initial:",h2h_id)
            comp_market = pull_markets([event_id])
            ou35_id=get_event_ou35(comp_market,event_id)"""
	...
	#DNB
        ...
        try:
            ...
            #print("found dnb_id initial:",h2h_id)
        except:
            #rint("notfound dnb_id initial:",h2h_id)
            comp_market = pull_markets([event_id])
            dnb_id=get_event_dnb(comp_market,event_id)"""
	...
	#DC
        ...
        try:
            ...
            #print("found dc_id initial:",h2h_id)
        except:
            #print("notfound dc initial:",h2h_id)
            comp_market = pull_markets([event_id])
            dc_id=get_event_dc(comp_market,event_id)
            """
	...
	#1x2_HT
        ...
        try:
            ...
            #print("found ht_id initial:",h2h_id)
        except:
            #print("notfound ht_id initial:",h2h_id)
            comp_market = pull_markets([event_id])
            ht_1x2_id=get_event_1x2_ht(comp_market,event_id)
...
def pull_betfair_data(compid,league,betfair_markets,foobar=None,events=[]):
    #print("BETFAIR DATA >>>")
