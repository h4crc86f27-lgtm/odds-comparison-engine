                ...
                if runner['name'].upper() in qrbet_teams and qrbet_teams[runner['name'].upper()]!="":
                    ...
                    for b in bf_teams:
                        ...
                        if r>maxfuzz and r>=40:
                            ...
                            if r>85:
                                break
                    #here splice this fuzzed match into the qrbet_teams db,, 
                    #print("inserting team to qrbet_teams..",likely_team,runner['name'])

                    #try:
                    #    cur.execute("insert into qrbet_teams (qrbet_name,betfair_name) values(%s,%s)",(runner['name'],likely_team))
                    #    conn.commit()
                    #except:
                    #    pass
