...
def betfair_data_thread(event_id,event):
        ...
        try:
            ...
            #print("found dc_id initial:",dc_id)
            book_list.append("dc")
            id_list.append(bf_markets[str(event_id) + "_Double Chance"])
        except:
            try:
                #print("notfound dc initial:",dc_id)
                comp_market = pull_markets([event_id])
                dc_id=get_event_dc(comp_market,event_id)
                #print(dc_id)
            except Exception as msg:
                dc_id=0
                #print("DC ERR, market no found? :: ",str(msg))
        ...
        try:
            #print("getting h2h book..")
            
            #print("runnercount:(h2h)",len(books[0].runners))
            which_side=0

            for runner in book_h2h.runners:
                which_side+=1
                if which_side==1:
                    which_market="1"
                elif which_side==2:
...
####### here do the other markets,, will clean this up later.
	#uo 2.5
        ...
        try:
            ...
            which_side=0
            for runner in book_ou25.runners:
                which_side+=1
                if which_side==1:
	...
	#uo 3.5
        ...
        try:
            ...
            if 1:#len(books)>0:
                ...
                which_side=0
                for runner in book_ou35.runners:
                    which_side+=1
                    if which_side==1:
	...
	#DNB
        ...
        try:
            ...
            if 1:#len(books)>0:
                ...
                which_side=0
                for runner in book_dnb.runners:
                    which_side+=1
                    if which_side==1:
...
def pull_betfair_data(compid,league,betfair_markets):
    #print("BETFAIR DATA >>>")
    global bf_markets
