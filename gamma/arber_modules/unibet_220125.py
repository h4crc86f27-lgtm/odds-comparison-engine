...
def pull_extra_markets_unibet(eventid):#="1018556845"):
    ...
    url="https://o1-api.aws.kambicdn.com/offering/v2018/ubau/betoffer/event/" + str(eventid) + ".json?lang=en_AU&market=NL&client_id=2&channel_id=1&includeParticipants=true"
...
def pull_data_unibet(compid,league):
    ...
    #premier league
    url="https://o1-api.aws.kambicdn.com/offering/v2018/ubau/listView/football/" + compid + ".json?lang=en_AU&market=NL&client_id=2&channel_id=1&ncid=1651722023500&useCombined=true"
    ...
    for cd in comp_data:
        try:
            pass#do_odds_history_insert("unibet", cd['id'],cd['book'],cd['markets'])
        except Exception as msg:
