...
def pull_data_toto(compid,league):#add comp_data as mutable param
    ...
    try:
        ...
        print("failed extra data thing..",str(msg))
    ...
    for cd in comp_data:
        try:
            pass#do_odds_history_insert("toto", cd['id'],cd['book'],cd['markets'])
        except Exception as msg:
